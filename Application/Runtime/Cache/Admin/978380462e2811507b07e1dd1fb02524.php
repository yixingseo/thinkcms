...
<script src="/thinkcms/Public/js/jquery-1.7.2.min.js"></script>
...
<div class="sidebar">
  <div class="list-group">
        <a href="/thinkcms/index.php/admin/article" class="list-group-item active" target="mainFrame"><i class="fa fa-files-o"></i> 内容管理 </a>
        <a href="/thinkcms/index.php/admin/article/add" class="list-group-item" target="mainFrame"><i class="fa fa-file-text-o"></i> 添加内容</a>
        <a href="/thinkcms/index.php/admin/article/rec" class="list-group-item" target="mainFrame"><i class="fa fa-recycle"></i> 回收站</a>

        <a href="/thinkcms/index.php/admin/category" class="list-group-item" target="mainFrame"><i class="fa fa-th-list"></i> 分类管理</a>
        <a href="/thinkcms/index.php/admin/category/add" class="list-group-item" target="mainFrame"><i class="fa fa-plus-circle"></i> 添加分类</a>
        ...
        <a href="/thinkcms/index.php/admin/db" class="list-group-item" target="mainFrame"><i class="fa fa-cog"></i> 数据管理</a>
